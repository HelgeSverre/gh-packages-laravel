...
use JordJD\LaravelAddresses\Traits\HasAddresses;
...
try {
    $address->validate();
} catch (\JordJD\LaravelAddresses\Exceptions\InvalidUKPostcodeException $e) {
...
```php
use \JordJD\LaravelAddresses\DistanceStrategies\Driving;
use \JordJD\LaravelAddresses\DistanceStrategies\Walking;
use \JordJD\LaravelAddresses\DistanceStrategies\Cycling;
