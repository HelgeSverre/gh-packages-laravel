...
$notifier = Notifier::discord('https://discord.com/api/webhooks/REDACTED');
```
...
$notifier = Notifier::slack('https://hooks.slack.com/services/REDACTED');
```
...
```bash
php artisan notifier -t=discord -w=https://discord.com/api/webhooks/REDACTED "Hello, Discord!"
```
